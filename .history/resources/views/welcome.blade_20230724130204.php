    ...
    <div class="container">
        ...
        <form action="/generate-barcode" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="email" name="barcodeData" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
            </div>
            <input class="form-control" type="text" name="barcodeData" placeholder="Enter barcode content">
