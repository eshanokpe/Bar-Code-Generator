...
<head>
    <title>Barcode Display</title>
     ...
     <link rel="icon" type="image/x-icon" href="{{ asset('public/logothl.png')}}">
                    ...
                    <div style="display: flex">
                        ...
                        <div class="mb-3">
                            <form action="{{ route('barcode.delete', ['id' => $barcodeDataImage['id']]) }}" method="POST" style="display: inline-block;">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger " style="margin-left: 10px" onclick="return confirm('Are you sure you want to delete this barcode?')">Delete</button>
                            </form>
                        </div>
                    </div>
